...
- **Casos pro Radar — recorte de revisão:** enquanto o caso está `pendente`, o drawer/form montam o trecho **por pessoa (telefone)**, juntando todas as sessões/instâncias do mesmo contato (janela de 30 dias antes do gatilho + tudo depois, com rótulo da sessão). Ao aprovar/descartar, o recorte visto é congelado em `messages_snapshot`/`transcript_snapshot`.
